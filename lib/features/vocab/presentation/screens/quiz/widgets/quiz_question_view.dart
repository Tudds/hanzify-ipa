...
import 'package:hanzify/core/widgets/hanzify_quiz_feedback_overlay.dart';
...
class QuizQuestionView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isCurrentCorrect = showResult && state.selectedAnswer == question.correctIndex;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Column(
            children: [
              ...
              HanzifyAppBar(
                ...
                title: modeLabel,
                titleStyle: AppTypography.label(
                    fontSize: 13,
          ...
          // Rive Feedback Overlay
          if (showResult)
            HanzifyQuizFeedbackOverlay(
